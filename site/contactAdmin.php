...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="formulaireAdminStyle.css">
...
<body>
    ...
    <nav>
        <p class="menu"><a href="admin.php" alt="Mathieu Caselles" title="Retour à l'accueil">Accueil</a></p>
